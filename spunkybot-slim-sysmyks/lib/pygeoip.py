...
http://python-geoip.googlecode.com/hg/pygeoip.py
'''
...
class ReadBuffer(object):
    ...
    def read_string(self):
        ...
        '''
        result, self.buffer = self.buffer.split(b'\0', 1)
    ...
    def read_int(self, size):
        ...
        '''
        result = sum(self.buffer[i] << (8 * i) for i in range(size))
...
class AddressInfo(object):
    ...
    '''
    __slots__ = ['ip', 'ipnum', 'prefix', 'country', 'country_name', 'continent']
    ...
    def __init__(self, ip=None, ipnum=None, prefix=None, country_id=None):
        ...
        self.country_name = safe_lookup(GeoIP_country_name, country_id)
...
class BigAddressInfo(AddressInfo):
    ...
    def __init__(self, ip=None, ipnum=None, prefix=None, country_id=None,
                 city=None, region=None, postal_code=None, metro_code=None,
                 area_code=None, longitude=None, latitude=None):
...
class Database(object):
    ...
    def _setup_segments(self):
        ...
        for i in range(STRUCTURE_INFO_MAX_SIZE):
            ...
            if delim != b'\xFF\xFF\xFF':
                fp.seek(-4, os.SEEK_CUR)
                continue

            self.db_type = fp.read(1)[0]
    ...
    def _seek_record(self, ipnum):
        ...
        for depth in range(31, -1, -1):
            ...
            buf = list(fp.read(self.record_length * 2))
    ...
    def _extract_record(self, seek_record, next_record_ptr):
        ...
        # get area code and metro code for post April 2002 databases and for
        # US locations
